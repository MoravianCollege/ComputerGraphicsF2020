...
function onMouseDown(e) {
    ...
    function onMouseMove_Position(e2) {
        ...
        // TODO: take the starting position and add x and y to it, saving it in the global position variable
        updateModelViewMatrix();
    }
    function onMouseMove_Rotation(e2) {
        let [x, y] = get_delta(e2);
        // TODO: take the starting rotation and add x and y to it, saving it in the global rotation variable
        updateModelViewMatrix();
    }
    function onMouseUp() {
