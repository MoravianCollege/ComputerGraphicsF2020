// Variable Animation Demo (solution)
'use strict';
...
function render(ms) {
    ...
    total_time += elapsed * +document.getElementById('speed').value;

    // Update position of models
    let z = Math.sin(total_time/2000*2*Math.PI) - 3;
    gl.uniformMatrix4fv(gl.program.uModelViewMatrix, false, mat4.fromTranslation(mat4.create(), [0, 0, z]));
