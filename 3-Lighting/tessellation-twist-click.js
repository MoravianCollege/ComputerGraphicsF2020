// Renders a triangle tessellation with a twist transformation that increases with clicking
'use strict';
...
function initProgram() {
    ...
    let vert_shader = compileShader(gl, gl.VERTEX_SHADER,
        ...
        // TODO: get theta from outside
        
        void main() {
            // TODO: set gl_Position using a twist transformation based on theta from outside
    ...
    program.aColor = gl.getUniformLocation(program, 'aColor'); // get the vertex shader attribute location for "aColor"
...
function onClick(e) {
    ...
    let theta = Math.sqrt(x*x + y*y) * Math.PI;
    // TODO: update the vertex shader's theta and re-render
}
