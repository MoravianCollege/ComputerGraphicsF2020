// Renders Sierpinski's Triangle in Color (solution)
'use strict';
...
function initBuffers() {
    ...
    let colors = [];
    while (colors.length*2 < coords.length*3) {
        colors.push(
            1, 0, 0, 1, 0, 0, 1, 0, 0, // 3 reds
            0, 1, 0, 0, 1, 0, 0, 1, 0, // 3 greens
            0, 0, 1, 0, 0, 1, 0, 0, 1); // 3 blues
    }
