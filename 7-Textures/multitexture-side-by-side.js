// A basic demo of using multiple textures that are drawn side-by-side
'use strict';
...
function initProgram() {
    ...
    let frag_shader = compileShader(gl, gl.FRAGMENT_SHADER,
        ...
        // Texture information
        // TODO: add texture uniforms (two of them)
        in vec2 vTexCoord;
        ...
        void main() {
            ...
            vec4 color = materialColor; // TODO: use both textures and vTexCoord to determine the color
