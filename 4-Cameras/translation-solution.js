// Model-View Matrix: Translation Demo (solution)
'use strict';
...
function initProgram() {
    ...
    let vert_shader = compileShader(gl, gl.VERTEX_SHADER,
        ...
        uniform mat4 uModelViewMatrix; // TODO: add uniform for model-view matrix
        uniform vec4 uLight;
        ...
        void main() {
            vec4 P = uModelViewMatrix * aPosition; // TODO: apply model-view matrix
            vNormalVector = mat3(uModelViewMatrix) * aNormal; // TODO: apply model-view matrix
...
function initEvents() {
    ...
    document.getElementById('translation-x').addEventListener('input', updateModelViewMatrix);
    document.getElementById('translation-y').addEventListener('input', updateModelViewMatrix);
    document.getElementById('translation-z').addEventListener('input', updateModelViewMatrix);
}
...
function updateModelViewMatrix() {
    ...
    glMatrix.mat4.fromTranslation(mv, [
        +document.getElementById('translation-x').value,
        +document.getElementById('translation-y').value,
        +document.getElementById('translation-z').value,
    ]);
