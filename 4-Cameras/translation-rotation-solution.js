// Model-View Matrix: Translation-Rotation Demo (solution)
'use strict';
...
function initEvents() {
    ...
    document.getElementById('translation1-x').addEventListener('input', updateModelViewMatrix);
    document.getElementById('translation1-y').addEventListener('input', updateModelViewMatrix);
    document.getElementById('translation1-z').addEventListener('input', updateModelViewMatrix);
    document.getElementById('rotation-x').addEventListener('input', updateModelViewMatrix);
    document.getElementById('rotation-y').addEventListener('input', updateModelViewMatrix);
    document.getElementById('rotation-z').addEventListener('input', updateModelViewMatrix);
    document.getElementById('translation2-x').addEventListener('input', updateModelViewMatrix);
    document.getElementById('translation2-y').addEventListener('input', updateModelViewMatrix);
    document.getElementById('translation2-z').addEventListener('input', updateModelViewMatrix);
}
...
function updateModelViewMatrix() {
    ...
    glMatrix.mat4.fromTranslation(mv, [
        +document.getElementById('translation1-x').value,
        +document.getElementById('translation1-y').value,
        +document.getElementById('translation1-z').value,
    ]);

    glMatrix.mat4.rotateX(mv, mv, deg2rad(document.getElementById('rotation-x').value));
    glMatrix.mat4.rotateY(mv, mv, deg2rad(document.getElementById('rotation-y').value));
    glMatrix.mat4.rotateZ(mv, mv, deg2rad(document.getElementById('rotation-z').value));

    glMatrix.mat4.translate(mv, mv, [
        +document.getElementById('translation2-x').value,
        +document.getElementById('translation2-y').value,
        +document.getElementById('translation2-z').value,
    ]);
