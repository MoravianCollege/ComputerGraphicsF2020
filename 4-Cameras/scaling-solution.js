// Model-View Matrix: Scaling Demo (solution)
'use strict';
...
function initEvents() {
    ...
    document.getElementById('scale-x').addEventListener('input', updateModelViewMatrix);
    document.getElementById('scale-y').addEventListener('input', updateModelViewMatrix);
    document.getElementById('scale-z').addEventListener('input', updateModelViewMatrix);
}
