...
function initProgram() {
    ...
    let vert_shader = compileShader(gl, gl.VERTEX_SHADER,
        ...
        void main() {
            vec4 P = aPosition; // TODO: apply model-view matrix
            vNormalVector = aNormal; // TODO: apply model-view matrix
    ...
    // TODO: get model-view matrix uniform location
...
function updateModelViewMatrix() {
    ...
    for (let i = 0; i < mv.length; i++) {
        document.getElementById('mv'+(i+1)).innerText = mv[i];
    }
}
